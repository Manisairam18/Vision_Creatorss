...
import ContactFormBG from "../assets/ContactFormAssets/BookAppointment_bg.jpg";
...
const OrderNow = () => {
    ...
    const handleDropdownSelect = (field, value) => {
        ...
        if (field === "giftsFor") setGiftsDropdownOpen(false);
    };
        ...
        <div className="min-h-screen flex justify-center p-6 relative">
            ...
            >
                ...
                <form className="mt-4 space-y-5" onSubmit={handleSubmit}>
                    ...
                    <Dropdown
                        label="Gifts for"
                        options={["Customers", "Executives", "Managers", "Employees"]}
                        isOpen={giftsDropdownOpen}
                        toggleDropdown={() => setGiftsDropdownOpen(!giftsDropdownOpen)}
                        selectedValue={formData.giftsFor}
                        onSelect={handleDropdownSelect}
                        field="giftsFor"
                    />
