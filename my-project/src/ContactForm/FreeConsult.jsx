...
const FreeConsult = () => {
    ...
    const SocialIcons = () => {
        ...
        return (
            <div className="mt-6">
                ...
                <div className="flex items-start gap-[10px] sm:gap-[20px] self-stretch mt-4">
    ...
    return (
        <div className="min-h-screen flex justify-center p-6">
            <div
                className="relative w-full md:w-[80%] lg:w-[60%] xl:w-[50%] 2xl:w-[35%] text-white p-6 md:p-10 lg:p-20"
                style={{
            ...
            >
                ...
                <h2 className="text-[28px] font-semibold leading-[125%] text-white self-stretch font-poppins">
                    Let's get started!
                </h2>
                ...
                <form className="mt-4 space-y-5" onSubmit={handleSubmit}>
                    ...
                    {[
                        ...
                        { label: "Your role*", id: "role", required: true },
                        { label: "Age", id: "age", required: false },
                    ...
                    {/* Your Available Dates Dropdown with Calendar */}
                    <div className="relative">
                        <div className="flex flex-col">
                            <input
                                type="text"
                                id="availableDate"
                                readOnly
                                value={formData.availableDate ? formData.availableDate.toLocaleDateString() : ""}
                                className="peer bg-transparent border-b border-white outline-none text-white h-10 order-1 mt-6 placeholder-transparent cursor-pointer"
                            ...
                            <img
                                src={DropDown}
                                alt="Dropdown"
                                className={`absolute right-2 top-8 w-7 h-7 cursor-pointer transition-transform duration-300 ${dateDropdownOpen ? "rotate-180" : "rotate-0"}`}
                                onClick={() => setDateDropdownOpen(!dateDropdownOpen)}
                            />
                        </div>
                    ...
                    {/* Your Available Time Input Field */}
                    ...
                    <div className="mt-20">
                        <button
                            type="submit"
                            className="bg-white w-max text-redCustom font-poppins text-[18px] font-semibold leading-[150%] py-2 px-6 flex items-center mt-10 mx-auto md:ml-60"
                            style={{ color: "#E92429" }}
                        >
                            Submit
                ...
                <div className="mt-6">
                    ...
                    <p className="self-stretch text-white font-inter text-[16px] font-normal leading-[150%] mt-4">
                        <a href="mailto:Vishancreators@gmail.com" className="no-underline">
                ...
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    ...
                    >
                        ...
                        <div className="flex flex-col items-center justify-center">
                            <h2 className="text-[36px] font-poppins font-semibold leading-[125%] text-white mt-8 ">
                                Thank you!
                            </h2>
                            <p className="text-[18px] font-inter font-normal leading-[150%] text-white mt--10">
