...
const DownloadForm = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (formData.agreeToTerms) {
            setIsSubmitted(true); // Show a thank-you message or handle download logic
        } else {
        ...
        <div className="min-h-screen flex justify-center p-6 relative">
            ...
            >
                ...
                <div className="flex flex-col items-center mb-6">
                    <img src={VishanCreatorsLogo} alt="Vishan Creators Logo" className="h-12 mb-4" />
                ...
                <form className="mt-4 space-y-5" onSubmit={handleSubmit}>
                    ...
                    <div className="mt-10 flex justify-center mr-4">
                        <button
                            type="submit"
                            className="bg-white w-max text-redCustom font-poppins text-[18px] font-semibold leading-[150%] py-2 px-6 flex items-center mt-7"
                            style={{ color: "#E92429" }}
                        >
                            Free Download
                        </button>
            ...
            {isSubmitted && (
                <div className="fixed inset-0 flex items-center justify-center z-50">
                    <div
                        ...
                        style={{
                            background: "linear-gradient(180deg, #E92429 0%, #00C4B4 100%)", // Gradient to match the image
                            backgroundSize: "cover",
                            backgroundPosition: "center",
                        }}
                    >
