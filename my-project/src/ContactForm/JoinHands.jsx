...
import UploadIcon from "../assets/ContactFormAssets/Upload_Icon.svg"; // Importing the upload icon
...
const JoinHands = () => {
    ...
    return (
        <div className="min-h-screen flex justify-center p-6 relative">
            <div
                className={`relative w-full md:w-[80%] lg:w-[60%] xl:w-[50%] 2xl:w-[35%] text-white p-6 md:p-10 lg:p-20 transition-all duration-300 ${
                    isSubmitted ? "blur-sm" : ""
            ...
            >
                ...
                <form className="mt-4 space-y-5" onSubmit={handleSubmit}>
                    ...
                    {[
                        ...
                        { label: "Website", id: "website", required: false },
                    ].map((field, index) => (
                        <div key={index} className="flex flex-col relative">
                            <input
                                type="text"
                    ...
                    <div className="flex flex-col relative">
                        ...
                        <div className="relative">
                            <input
                                ...
                                className="peer bg-transparent border-b border-white outline-none text-white h-10 order-1 mt-6 placeholder-transparent cursor-pointer w-full pr-10" // Added w-full and pr-10 for proper alignment
                            ...
                            <img
                                src={UploadIcon}
                                alt="Upload"
                                className="absolute right-2 top-8 w-7 h-7 cursor-pointer"
                                onClick={() => document.getElementById("profile").click()}
                            />
                        </div>
                    </div>
